...
const CITIES = [
  ...
  { label: 'Montreal',         tz: 'America/Montreal' },
  ...
  { label: 'Havana',           tz: 'America/Havana' },
  { label: 'Panama City',      tz: 'America/Panama' },
  ...
  { label: 'Copenhagen',       tz: 'Europe/Copenhagen' },
  ...
  { label: 'Edinburgh',        tz: 'Europe/London' },
  ...
  { label: 'Khartoum',         tz: 'Africa/Khartoum' },
  { label: 'Algiers',          tz: 'Africa/Algiers' },
  ...
  { label: 'Kuwait City',      tz: 'Asia/Kuwait' },
